...
// Both networks, for code that picks one at runtime (the gateway defaults to mainnet).
// PredgeSettlement landed on the same address on both chains.
export const ARC_NETWORKS = {
  mainnet: {
    ...
    settlement: "0x3474Bd2747cb1D430C2F56050433fa5D6b1C82A5",
  },
  testnet: {
    name: "arc-testnet",
    chainId: 5042002n,
...
export function makeProvider(rpc = DEFAULT_RPC, chainId = ARC_CHAIN_ID) {
